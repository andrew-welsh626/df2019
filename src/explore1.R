library(lubridate)
library(dplyr)
gps <- read_csv("C:/Users/andre/Desktop/Datafest Project/df2019/data/gps.csv")
View(gps)

games.dates <- read_csv("C:/Users/andre/Desktop/Datafest Project/df2019/data/games.csv", 
                        col_types = cols(Date = col_date(format = "%Y-%m-%d")))
games <- read_csv("C:/Users/andre/Desktop/Datafest Project/df2019/data/games.csv")
wellness <- read_csv("C:/Users/andre/Desktop/DataFest Project/df2019/data/wellness.csv", 
...
#-----------------------------------------------------------------------
rpe <- read_csv("C:/Users/andre/Desktop/DataFest Project/df2019/data/rpe.csv", 
                col_types = cols(Date = col_date(format = "%Y-%m-%d")))
View(well.acr2)
